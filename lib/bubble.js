...
<div id="ultimatter-bubble-root">
  ...
  <div id="ultimatter-fab" title="Tap to switch agents">🚀</div>
  ...
  <div id="ultimatter-drawer-backdrop">
    <div id="ultimatter-drawer">
      ...
      <button class="ultimatter-hub-btn" onclick="window.location.href='/hub'">
        <span>🏠</span>
      ...
      var renderDrawerList = function() {
        ...
        fetch('/api/bridge-status')
          ...
          .then(function(data) {
            ...
            if (agents.length === 0) {
              list.innerHTML = '<div style="text-align:center;padding:12px;color:#64748b;font-size:12px;">No other agents active on PC</div>';
              return;
            }
          ...
          .catch(function() {
            list.innerHTML = '<div style="text-align:center;padding:12px;color:#64748b;font-size:12px;">Unable to fetch active agents</div>';
          });
      };
