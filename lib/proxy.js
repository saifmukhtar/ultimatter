...
const startProxy = (localIpOrOptions, optionalTailscaleDns = null) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    secureServer.listen(proxyPort, '0.0.0.0', () => {
      const localUrl = `https://${localIp}:${proxyPort}/?token=${auth.SECURE_TOKEN}`;
      const tailscaleUrl = tailscaleDns ? `https://${tailscaleDns}:${proxyPort}/?token=${auth.SECURE_TOKEN}` : null;
