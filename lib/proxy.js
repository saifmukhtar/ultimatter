...
<body>
  <div class="card">
    ...
    <p class="desc">The encrypted gateway is active. Launch your AI coding agent on your desktop to begin.</p>
    <div class="target-preview">
      <div class="target-chip"><span>🛸</span> Antigravity</div>
      <div class="target-chip"><span>👐</span> OpenCode</div>
    </div>
