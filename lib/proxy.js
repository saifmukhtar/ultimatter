...
const startProxy = (localIp, tailscaleDns = null) => {
  ...
  const requestHandler = (req, res) => {
    ...
    // Local Root CA Certificate Download Route
    if (pathname === '/api/ca.pem') {
      ...
      res.end(`<!DOCTYPE html>
        ...
        <head>
          ...
          <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            h2 { font-size: 19px; font-weight: 700; color: #0f172a; letter-spacing: -0.3px; }
            p { font-size: 13px; color: #64748b; line-height: 1.5; }
            .badge {
              display: inline-flex;
              align-items: center;
        ...
        <body>
          <div class="card">
            ...
            <p>Scan the dynamic QR code displayed on your PC's <strong>Ultimatter Control Panel</strong> to securely link your phone.</p>
