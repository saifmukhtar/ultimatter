...
const startProxy = (localIpOrOptions, optionalTailscaleDns = null) => {
  ...
  const requestHandler = (req, res) => {
    ...
    if (pathname.startsWith('/agent/')) {
      ...
      res.writeHead(302, {
        'Set-Cookie': `selected_agent=${encodeURIComponent(agentId)}; Path=/; Max-Age=2592000; SameSite=Lax`,
    ...
    if (shouldServeHub) {
      ...
      res.writeHead(200, {
        ...
        'Set-Cookie': 'selected_agent=; Path=/; Max-Age=0; SameSite=Lax'
      });
      res.end(hub.getHubHtml(catalogTargets, enabledActiveTargets, auth.SECURE_TOKEN));
      return;
    }
