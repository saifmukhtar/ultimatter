...
<head>
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', checkPwaMode);
    ...
    <div class="ca-download-card">
      <div class="ca-left">
        ...
        <div>
          ...
          <div class="ca-desc">Install on phone for zero-warning HTTPS on Wi-Fi</div>
        </div>
      </div>
      <a href="/api/ca.pem" download class="btn-ca">Download ↓</a>
    </div>
